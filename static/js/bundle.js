...
/* harmony import */ var _indexForm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./indexForm */ "./src/js/indexForm.js");
/* harmony import */ var _indexOffers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./indexOffers */ "./src/js/indexOffers.js");
/* harmony import */ var _indexOffers__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_indexOffers__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _indexVideo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./indexVideo */ "./src/js/indexVideo.js");
/* harmony import */ var _indexVideo__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_indexVideo__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _indexPopup__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./indexPopup */ "./src/js/indexPopup.js");
/* harmony import */ var _indexCurrency__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./indexCurrency */ "./src/js/indexCurrency.js");
/* harmony import */ var _indexChart__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./indexChart */ "./src/js/indexChart.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var chart_js_dist_Chart_bundle_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chart.js/dist/Chart.bundle.min */ "./node_modules/chart.js/dist/Chart.bundle.min.js");
...
var ctxMob = document.getElementById('ct-chart-mob').getContext("2d");
...
var gradientFillMob = ctxMob.createLinearGradient(0, 0, 0, 350);
...
function getDoughnut(element, title) {
  ...
  var labels = [];
  STATES[title].labels.forEach(function (element, index) {
...
var myChartMob = new Chart(ctxMob, optionsMob);
var myChart = new Chart(ctx, options); // TABS

var tabs = [].slice.call(document.getElementsByClassName('chart-xAxis__item'));
tabs.forEach(function (element, index) {
  element.addEventListener('click', function (e) {
    ...
    var month = STATES[e.target.innerHTML];
    var labels = month.labels;
    var values = month.data;
    ...
    for (var _i = 0; _i < labels.length; _i++) {
      ...
      key.innerHTML = labels[_i];
      var value = document.createElement('p');
      value.classList.add('tooltip__value');
      value.innerHTML = values[_i] + '%';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _indexPopup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./indexPopup */ "./src/js/indexPopup.js");

var errorValidMail = 'The E-mail you have entered is not valid!',
...
function getAlert(text) {
  ...
  _indexPopup__WEBPACK_IMPORTED_MODULE_0__["hideScroll"]();
  button.addEventListener('click', function (e) {
    document.body.removeChild(wrapper);
    _indexPopup__WEBPACK_IMPORTED_MODULE_0__["showScroll"]();
    alert = false;
  });
...
/* WEBPACK VAR INJECTION */(function($) {var packages = [].slice.call(document.getElementsByClassName('package'));
  ...
  element.addEventListener('mouseenter', function (e) {
    if (window.matchMedia("(min-width: 1181px)").matches) {
      ...
      for (var i = 0; i < packages.length; i++) {
        if (i !== index) {
          var _element = packages[i];

          _element.classList.remove('package_active');
        }
      }
    }
  });
...
function packagesMedia(x) {
  if (x.matches) {
    ...
    for (var _i = 0; _i < packages.length; _i++) {
      if (_i !== 1) {
        var _element2 = packages[_i];

        _element2.classList.remove('package_active');
      }
    }
  }
}
...
var media1180 = window.matchMedia("(max-width: 1180px)");
var media640 = window.matchMedia("(max-width: 640px)");
...
var headVideoBg = document.querySelector('.head__bg-video'); // headVideoBtn && headVideoBtn.addEventListener('click', playPause);
// function playPause() {
